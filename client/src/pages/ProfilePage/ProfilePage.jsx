  ...
  useEffect(() => {
    (async () => {
      try {
        const {
          data: { user },
        } = await axios.get(`https://socialley.sohamsshah.repl.co/user/${_id}`);
        console.log(user);
    ...
    <div className={styles["profile-wrapper"]}>
      ...
      <div className={styles["profile-details"]}>
        <div className={styles["profile-details-banner"]}>
          ...
          <div className={styles["profile-details-username"]}>
            @{user.username}
          </div>
          <div className={styles["profile-details-stats"]}>
            <div className={styles["profile-details-followers"]}>
              ...
              <span className={styles["stats-data"]}>
          ...
          <div className={styles["profile-bio"]}>{user.bio}</div>
        </div>
        {isUserProfile ? (
          <div className={styles["saved-chats"]}>
            <div className={styles["saved-chats-title"]}>Your Saved Chats</div>
            <RoomCard
              page="profile"
              topic="React JS"
              participants={["Soham", "Rohit", "Prerana"]}
              moderators={["Soham", "Rohit", "Prerana"]}
            />
            <RoomCard
              page="profile"
              topic="React JS"
