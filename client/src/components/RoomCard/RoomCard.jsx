    ...
    return (
        <div className={styles["room-card"]}>
              ...
              <div className={styles["moderator-names"]}>
                {moderators.map((user) => <span>{user}, </span>)}
              </div>
              ...
              <div className={styles["room-stats"]}>
                ...
                {(page === "home") ? <div className={styles["room-chatters"]}><PhChatCenteredDots /> <div>{participants.length}</div></div>:"" }
                
              </div>
              {(page === "profile") ? <div className={styles["room-saved"]}>Saved on 2 May 2021</div> : ""}
            </div>
    )
}
